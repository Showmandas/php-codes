...
if(isset($_POST['done'])){
   ...
   $bldgrp = $_POST['bldgrp'];
    ...
    $q=" UPDATE `crud` SET ID=$id,Fullname='$fullname',Email='$email',District='$district',Gender='$gender',Blood_Group='$bldgrp' WHERE ID=$id ";
...
<div class="col-lg-6 m-auto">
    <form action="" method="post"></br></br>
      ...
      <h1 class="text-white text-center">Update Your Data Here</h1>
      </div><br>
